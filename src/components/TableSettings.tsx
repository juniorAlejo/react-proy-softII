...
export interface TableProps {
  rows: any[]; // Asumiendo que `rows` es un arreglo de objetos genéricos
  deleteRow: (idx: number) => void; // Función para borrar una fila
  editRow: (idx: number) => void; // Función para editar una fila
}
